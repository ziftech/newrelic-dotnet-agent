...
namespace NewRelic.Agent.IntegrationTests.RemoteServiceFixtures
{
    public class AspNetCoreDistTraceRequestChainFixture : RemoteApplicationFixture
    {
        ...
        public AspNetCoreDistTraceRequestChainFixture()
            : base(new RemoteService(ApplicationDirectoryName, ExecutableName, "net5.0", ApplicationType.Bounded, true, true, true))
        {
        ...
        {
            var service = new RemoteService(ApplicationDirectoryName, ExecutableName, "net5.0", ApplicationType.Bounded, true, true, true);
